...
texTexture texture1, texture2, texture3, texture4, texture5;
texTexture *textures[texNUM] = {&texture1, &texture2, &texture3, &texture4, &texture5};
...
int initializeArtwork(void) {
    ...
    //Body Material Uniforms and textures
